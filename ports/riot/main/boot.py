...
if 1:  # test `voucher` module
    ...
    def wip():
        ...
        #v.dump()
        test_assert_eq('get_content', v.get_content(), # the CBOR-encoded `COSE_Sign1` structure, a.k.a. `to_verify`
        ...
        test_assert_eq('get_signature', v.get_signature(), bytes([99, 204, 130, 58, 52, 185, 100, 173, 200, 53, 181, 142, 46, 225, 231, 227, 0, 136, 173, 230, 137, 111, 148, 177, 58, 199, 48, 100, 62, 150, 96, 181, 169, 52, 83, 243, 201, 216, 160, 154, 181, 122, 1, 19, 164, 6, 114, 120, 132, 118, 58, 42, 208, 75, 79, 171, 79, 111, 184, 188, 179, 46, 250, 71]))
        test_assert_eq('get_signature_algorithm', v.get_signature_algorithm(), SA_ES256)
