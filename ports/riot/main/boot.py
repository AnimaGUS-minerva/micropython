...
if 1:  # test `voucher` module
    ...
    def wip():
        ...
        KEY_PEM_F2_00_02 = debug_get_key_pem_F2_00_02()        # debug, privkey
        ...
        test_assert('vch_jada.validate() - without PEM, `signer_cert` is used instead',
            from_cbor(debug_get_vch_jada()).validate())
        test_assert('vch_f2.validate() - without PEM, should fail',
            not from_cbor(debug_get_vch_F2_00_02()).validate())
        test_assert('vrq_f2.validate() - without PEM, should fail',
            not from_cbor(debug_get_vrq_F2_00_02()).validate())
        ...
        obj_vch_jada = from_cbor(debug_get_vch_jada())
        obj_vch_f2 = from_cbor(debug_get_vch_F2_00_02())
        obj_vrq_f2 = from_cbor(debug_get_vrq_F2_00_02())
        ...
        test_assert_eq('to_cbor() - obj_vch_jada', obj_vch_jada.to_cbor(), debug_get_vch_jada())
        test_assert_eq('to_cbor() - obj_vch_f2', obj_vch_f2.to_cbor(), debug_get_vch_F2_00_02())
        test_assert_eq('to_cbor() - obj_vrq_f2', obj_vrq_f2.to_cbor(), debug_get_vrq_F2_00_02())
        ...
        vch = voucher.from_cbor(debug_get_vch_jada())
        vch.debug_dump()
        ...
        vch = voucher.from_cbor(debug_get_vch_jada())#.debug_dump()
        ...
        v = from_cbor(debug_get_vch_jada())
        ...
        v = from_cbor(debug_get_vch_F2_00_02())
        ...
        v = from_cbor(debug_get_vch_jada())#.debug_dump()
        ...
        v = from_cbor(debug_get_vch_F2_00_02())#.debug_dump()
        ...
        v = from_cbor(debug_get_vrq_F2_00_02())#.debug_dump()
